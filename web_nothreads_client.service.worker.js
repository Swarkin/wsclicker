...
/** @type {string} */
const CACHE_VERSION = '1727482844|117715389';
/** @type {string} */
const CACHE_PREFIX = 'wsclicker-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'web_nothreads_client.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["web_nothreads_client.html","web_nothreads_client.js","web_nothreads_client.offline.html","web_nothreads_client.worker.js","web_nothreads_client.audio.worklet.js","web_nothreads_client.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["web_nothreads_client.wasm","web_nothreads_client.pck"];
const FULL_CACHE = CACHED_FILES.concat(CACHABLE_FILES);

// This causes an infinite reload loop.
